...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        score = 0
        #use unlocal could cause side effect
        last_score_say = last_score
        running_high_say = running_high
        if who:
            score = score1 - last_score_say
            last_score_say = score1
        else:
            score = score0 - last_score_say
            last_score_say = score0
        if score > running_high_say:
            running_high_say = score
            print(score, " point(s)! That's a record gain for Player ", who, "!", sep="")
        return announce_highest(who, last_score_say, running_high_say)
    return say
    # END PROBLEM 7
...
def picky_piggy_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    extra_score = picky_piggy(opponent_score)
    if extra_score >= cutoff:
        return 0
    else:
        return num_rolls
    # END PROBLEM 10
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return hog_pile_strategy(score, opponent_score)  # Remove this line once implemented.
    # END PROBLEM 12
